...
site_fields = [
    ...
    S('Footer copyright', 'footer_copyright',
      hint='Bottom line of the footer, e.g. © 2026 ViTalRank. All rights reserved.'),
    LST('Contact info', 'contact_info', [
        S('Label', 'label', hint='e.g. Email, Phone, Address'),
        S('Text', 'text', hint='What visitors see'),
        S('Link URL', 'href', required=False,
          hint='e.g. mailto:you@domain.com or tel:+15551234567. Leave empty for plain text.')]),
]
